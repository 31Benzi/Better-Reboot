...
abstract class AppLocalizations {
  ...
  /// No description provided for @settingsUtilsDiscordRpcName.
  ///
  /// In en, this message translates to:
  /// **'Discord Rich Presence'**
  String get settingsUtilsDiscordRpcName;

  /// No description provided for @settingsUtilsDiscordRpcDescription.
  ///
  /// In en, this message translates to:
  /// **'Show launcher and game activity on Discord'**
  String get settingsUtilsDiscordRpcDescription;

  /// No description provided for @settingsUtilsDiscordRpcNotConfigured.
  ///
  /// In en, this message translates to:
  /// **'Set your Discord application ID in gui/lib/src/config/discord_rpc_config.dart'**
  String get settingsUtilsDiscordRpcNotConfigured;
  ...
  ///
  /// In en, this message translates to:
  /// **'Welcome to Better Reboot Launcher'**
  ...
  ///
  /// In en, this message translates to:
  /// **'If you don\'t want to use the server browser, other players can join\nyou server by using your Better Reboot Launcher link or your public IP.'**
