...
import 'package:reboot_launcher/src/service/discord_rpc_service.dart';
...
class _LaunchButtonState extends State<LaunchButton> {
  ...
  Future<GameInstance?> _startGameProcesses(GameVersion version, bool host, bool headless, GameInstance? linkedHosting) async {
    ...
    final eacEosProcess = eacProcess == null
        ? await _createPausedProcess(version, host, kEacEosExe)
        : null;
    final gameProcess = await _createGameProcess(version, host, headless, eacEosProcess != null, linkedHosting);
    if(gameProcess == null) {
    ...
    final instance = GameInstance(
        ...
        eacPid: eacProcess ?? eacEosProcess,
  ...
  Future<int?> _createGameProcess(GameVersion version, bool host, bool headless, bool eacEos, GameInstance? linkedHosting) async {
  ...
  Future<void> _onLoggedIn(bool host) async {
    ...
    if(instance != null && !instance.launched) {
      ...
      unawaited(DiscordRpcService.optional?.syncPresence());
    }
  }
