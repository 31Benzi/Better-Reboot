...
class SettingsController extends GetxController {
  ...
  late final RxBool discordRichPresence;
  late double width;
  late double height;
  late double? offsetX;
  late double? offsetY;
  ...
  SettingsController() {
    ...
    discordRichPresence = RxBool(_storage?.read("discord_rich_presence") ?? true);
    discordRichPresence.listen((value) => _storage?.write("discord_rich_presence", value));
  }
