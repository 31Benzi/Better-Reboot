...
begin
  Page := CreateInputOptionPage(
         wpWelcome,
        '   Allow DLL injection',
        ' The Better Reboot Launcher needs to inject DLLs into Fortnite to create the game server',
        'Selecting the option below will add the Better Reboot Launcher to the Windows Exclusions list. ' +
        ...
        'If you do not trust the Better Reboot Launcher, you can audit the source code at https://github.com/31Benzi/Better-Reboot and build it from source.',
        False,
        False
  );
