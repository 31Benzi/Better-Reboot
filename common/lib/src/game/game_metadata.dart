...
List<String> createRebootArgs(String username, String password, bool host, bool headless, bool logging, bool eacEos, String additionalArgs) {
  ...
  args.addAll({
    ...
    "-caldera": eacEos ? kCalderaEacEos : kCalderaEac,
    "-AUTH_LOGIN": username,
